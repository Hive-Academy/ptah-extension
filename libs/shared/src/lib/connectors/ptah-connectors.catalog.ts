...
export const PTAH_CONNECTORS: readonly PtahConnector[] = [
  ...
  },
  {
    ...
    setupSteps: [
      'Open the Google Cloud console and create an OAuth client of type Web application.',
      'Add {redirectUrl} to the authorized redirect URIs.',
      'Enable the Google Sheets API, the Google Drive API and the Sheets MCP API.',
      'Add the scopes listed below to the OAuth consent screen.',
      'Copy the client ID and client secret into the fields below.',
    ],
    scopes: [
  ...
  },
  {
    ...
    setupSteps: [
      'Open the Google Cloud console and create an OAuth client of type Web application.',
      'Add {redirectUrl} to the authorized redirect URIs.',
      'Enable the Google Slides API, the Google Drive API and the Slides MCP API.',
      'Add the scopes listed below to the OAuth consent screen.',
      'Copy the client ID and client secret into the fields below.',
    ],
    scopes: [
  ...
  },
  {
    ...
    setupSteps: [
      'Open the Google Cloud console and create an OAuth client of type Web application.',
      'Add {redirectUrl} to the authorized redirect URIs.',
      'Enable the Google Chat API and the Chat MCP API for the project.',
      'Add the scopes listed below to the OAuth consent screen.',
      'Copy the client ID and client secret into the fields below.',
    ],
    scopes: [
  ...
  },
  {
    ...
    setupSteps: [
      'Open the Google Cloud console and create an OAuth client of type Web application.',
      'Add {redirectUrl} to the authorized redirect URIs.',
      'Enable the People API and the People MCP API for the project.',
      'Add the scopes listed below to the OAuth consent screen.',
      'Copy the client ID and client secret into the fields below.',
    ],
    scopes: [
  ...
  },
  {
    ...
    setupSteps: [
      'Open your Asana developer console and create a new app.',
      'Add {redirectUrl} to the redirect URLs of the app, character for character.',
      'Choose the workspaces the app may authorize.',
      'Copy the client ID and client secret into the fields below.',
    ],
    verifiedAt: VERIFIED_AT,
  },
