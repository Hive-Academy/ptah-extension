export const AUTH_PROVIDERS_TOKENS = {
  ...
  SDK_CODEX_HOME_RESOLVER: Symbol.for('SdkCodexHomeResolver'),
  SDK_CODEX_ACCOUNT_USAGE: Symbol.for('SdkCodexAccountUsage'),
  CODEX_HOME_OVERRIDE: Symbol.for('CodexHomeOverride'),
  CODEX_ENV_OVERRIDE: Symbol.for('CodexEnvOverride'),
  CODEX_HOMEDIR_OVERRIDE: Symbol.for('CodexHomedirOverride'),
