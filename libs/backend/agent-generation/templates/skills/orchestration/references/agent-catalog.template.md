...
Comprehensive catalog of specialist agents with capabilities, triggers, and invocation patterns.
...
## Selected Agents for {{PROJECT_NAME}}
...
Task({
  ...
  prompt: `You are project-manager for TASK_[ID].
