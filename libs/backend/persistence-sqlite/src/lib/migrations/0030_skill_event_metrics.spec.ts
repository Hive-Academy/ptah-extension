...
describe('migration 0030_skill_event_metrics — registry entry', () => {
  ...
  it('is the highest version (appended, not inserted)', () => {
    // Bumped to 38 when TASK_2026_277 appended
    // 0038_gateway_message_turn_state (previously 37, 36, 35, 34, 33, then 32 —
    // TASK_2026_180's phases 4, 3, 0, 2, 1 and 0). This assertion tracks the
