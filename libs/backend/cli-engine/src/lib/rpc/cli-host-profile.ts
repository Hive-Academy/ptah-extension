 ...
 * filesystem RPC, a command palette, an embedded editor pane, an embedded PTY,
 * and the desktop updater. Those capabilities stay off and their methods fall
 * out as derived exclusions.
 *
