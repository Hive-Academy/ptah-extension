...
export interface StoredSession {
  /**
   * Internal session identifier (generated by Ptah)
   */
  readonly id: SessionId;

  /**
   * Real Claude session UUID from SDK's system message
   * This is the ID that Claude CLI recognizes for session resumption.
   * May be null initially (set when first system message arrives).
   */
