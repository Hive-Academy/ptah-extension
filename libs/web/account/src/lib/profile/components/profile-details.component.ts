...
export class ProfileDetailsComponent {
  ...
  public builderPromoMessage(): string {
    return (
      ...
      'Apply to the Early Adopter program: approved founding members get a full year of Ptah Builders free — the SaaS-building course, weekly live sessions and the private community — on top of the open-source core you already have. No card, now or later.'
    );
  }
