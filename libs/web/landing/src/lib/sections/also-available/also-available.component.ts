    ...
    >
      ...
      >
        ...
        <p class="text-ink-400 text-base leading-relaxed mt-4">
          Ptah also ships as a VS Code extension and a headless CLI for CI/CD
          and scripted workflows. Same license, same seven providers — without
          the desktop-only Memory, Skills, Cron, and Gateway suite, which
