...
@Component({
  selector: 'ptah-provider-settings',
  standalone: true,
    ...
    <div class="provider-settings-container">
      ...
      <div class="settings-section">
        ...
        <div class="section-content">
          <ptah-provider-selector-dropdown
      ...
      <div class="settings-section">
        ...
        <div class="section-content">
          <div class="capabilities-grid">
            ...
            <div
              class="capability"
              [class.enabled]="capabilities.fileAttachments"
            >
              <div class="capability-icon">📎</div>
              <div class="capability-info">
            ...
            <div
              class="capability"
              [class.enabled]="capabilities.codeGeneration"
            >
              <div class="capability-icon">💻</div>
              <div class="capability-info">
            ...
            <div
              class="capability"
              [class.enabled]="capabilities.imageAnalysis"
            >
            ...
            <div
              class="capability"
              [class.enabled]="capabilities.functionCalling"
            >
              <div class="capability-icon">⚡</div>
              <div class="capability-info">
