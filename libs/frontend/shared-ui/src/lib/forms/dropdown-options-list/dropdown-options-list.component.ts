...
/**
 * Dropdown Options List Component - Angular 20+ Modernized
...
export class DropdownOptionsListComponent {
  // Signal-based inputs (Angular 20+)
  options = input<DropdownOption[]>([]);
  selectedValue = input<string>('');
  focusedIndex = input<number>(-1);
  hasSearchTerm = input<boolean>(false);
