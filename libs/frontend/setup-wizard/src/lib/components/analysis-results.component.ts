  ...
  template: `
    <div class="container mx-auto px-6 py-12 max-w-4xl">
        ...
        <div class="card-body">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <span class="ml-2 badge badge-primary badge-lg">{{ analysis.projectType }}</span>
            </div>

            <!-- File Count -->
            <div>
              <span class="font-semibold text-base-content/80">Total Files:</span>
              <span class="ml-2 text-base-content">{{ analysis.fileCount | number }}</span>
            </div>
            ...
            <div class="md:col-span-2">
              ...
              <span class="ml-2 text-success">
                Yes
                <span class="text-base-content/60 text-sm">({{ analysis.monorepoType }})</span>
              </span>
            </div>
            }
          </div>
          ...
          <div class="space-y-4">
            ...
            <div class="p-4 bg-base-100 rounded-lg">
              ...
              <div class="mt-2">
                ...
                <span class="text-xs text-base-content/60">{{ pattern.evidence.slice(0, 3).join(', ') }}</span>
                @if (pattern.evidence.length > 3) {
                <span class="text-xs text-base-content/60"> +{{ pattern.evidence.length - 3 }} more</span>
                }
              </div>
              }
            </div>
          ...
          <div class="space-y-2">
            ...
            <div tabindex="0" class="collapse collapse-arrow bg-base-100">
              <div class="collapse-title font-medium">
                Entry Points
                <span class="badge badge-sm badge-ghost ml-2">{{ analysis.keyFileLocations.entryPoints.length }}</span>
              </div>
              <div class="collapse-content">
                <ul class="text-sm text-base-content/80 space-y-1">
                  @for (file of analysis.keyFileLocations.entryPoints; track file) {
                  <li class="font-mono text-xs truncate" [title]="file">{{ file }}</li>
                  }
                </ul>
              </div>
            </div>
            ...
            <div tabindex="0" class="collapse collapse-arrow bg-base-100">
              <div class="collapse-title font-medium">
                Configuration Files
                <span class="badge badge-sm badge-ghost ml-2">{{ analysis.keyFileLocations.configs.length }}</span>
              </div>
              <div class="collapse-content">
                <ul class="text-sm text-base-content/80 space-y-1">
                  @for (file of analysis.keyFileLocations.configs.slice(0, 10); track file) {
                  <li class="font-mono text-xs truncate" [title]="file">{{ file }}</li>
                  }
                  @if (analysis.keyFileLocations.configs.length > 10) {
                  <li class="text-xs text-base-content/60">+{{ analysis.keyFileLocations.configs.length - 10 }} more files</li>
                  }
                </ul>
              </div>
            </div>
            ...
            <div tabindex="0" class="collapse collapse-arrow bg-base-100">
              <div class="collapse-title font-medium">
                Test Directories
                <span class="badge badge-sm badge-ghost ml-2">{{ analysis.keyFileLocations.testDirectories.length }}</span>
              </div>
              <div class="collapse-content">
                <ul class="text-sm text-base-content/80 space-y-1">
                  @for (dir of analysis.keyFileLocations.testDirectories; track dir) {
                  <li class="font-mono text-xs truncate" [title]="dir">{{ dir }}</li>
                  }
                </ul>
              </div>
            </div>
            ...
            <div tabindex="0" class="collapse collapse-arrow bg-base-100">
              <div class="collapse-title font-medium">
                Components
                <span class="badge badge-sm badge-ghost ml-2">{{ analysis.keyFileLocations.components.length }}</span>
              </div>
              <div class="collapse-content">
                <ul class="text-sm text-base-content/80 space-y-1">
                  @for (dir of analysis.keyFileLocations.components.slice(0, 10); track dir) {
                  <li class="font-mono text-xs truncate" [title]="dir">{{ dir }}</li>
                  }
                  @if (analysis.keyFileLocations.components.length > 10) {
                  <li class="text-xs text-base-content/60">+{{ analysis.keyFileLocations.components.length - 10 }} more</li>
                  }
                </ul>
              </div>
            </div>
            ...
            <div tabindex="0" class="collapse collapse-arrow bg-base-100">
              <div class="collapse-title font-medium">
                Services
                <span class="badge badge-sm badge-ghost ml-2">{{ analysis.keyFileLocations.services.length }}</span>
              </div>
              <div class="collapse-content">
                <ul class="text-sm text-base-content/80 space-y-1">
                  @for (dir of analysis.keyFileLocations.services.slice(0, 10); track dir) {
                  <li class="font-mono text-xs truncate" [title]="dir">{{ dir }}</li>
                  }
                  @if (analysis.keyFileLocations.services.length > 10) {
                  <li class="text-xs text-base-content/60">+{{ analysis.keyFileLocations.services.length - 10 }} more</li>
                  }
                </ul>
              </div>
            </div>
            ...
            <div tabindex="0" class="collapse collapse-arrow bg-base-100">
              <div class="collapse-title font-medium">
                API Routes
                <span class="badge badge-sm badge-ghost ml-2">{{ analysis.keyFileLocations.apiRoutes.length }}</span>
              </div>
              <div class="collapse-content">
                <ul class="text-sm text-base-content/80 space-y-1">
                  @for (route of analysis.keyFileLocations.apiRoutes.slice(0, 10); track route) {
                  <li class="font-mono text-xs truncate" [title]="route">{{ route }}</li>
                  }
                  @if (analysis.keyFileLocations.apiRoutes.length > 10) {
                  <li class="text-xs text-base-content/60">+{{ analysis.keyFileLocations.apiRoutes.length - 10 }} more</li>
                  }
                </ul>
              </div>
            </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        @if (analysis.languageDistribution && analysis.languageDistribution.length > 0) {
        ...
        <div class="card bg-base-200 shadow-xl">
          <div class="card-body">
            ...
            <div class="mb-4">
              <span class="text-sm font-semibold text-base-content/80">Existing Issues:</span>
            ...
            <div>
              <span class="text-sm font-semibold text-base-content/80">Test Coverage Estimate:</span>
              <div class="mt-2">
                @if (analysis.testCoverage.hasTests) {
                <div class="flex items-center gap-2 mb-2">
                  <div class="radial-progress text-primary" [style]="'--value:' + analysis.testCoverage.percentage + '; --size:4rem;'" role="progressbar" [attr.aria-valuenow]="analysis.testCoverage.percentage">
                    {{ analysis.testCoverage.percentage }}%
                  </div>
                  <div class="text-sm">
                    @if (analysis.testCoverage.testFramework) {
                    <div class="badge badge-outline badge-sm">{{ analysis.testCoverage.testFramework }}</div>
                    }
