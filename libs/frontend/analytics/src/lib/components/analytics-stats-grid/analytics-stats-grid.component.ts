...
/**
 * Analytics Stats Grid Component - Pure Presentation Component
 ...
 *
 * Modernizations:
 * - ✅ Selector: vscode-analytics-stats-grid → ptah-analytics-stats-grid
 * - ✅ @Input() → input.required() for statsData (SIGNAL-BASED)
        ...
        <div class="vscode-stats-content">
          <div
            ...
            [attr.aria-label]="
              ...
              ' ' +
              statsData().todayStats.label
            "
          >
            {{ statsData().todayStats.sessions }}
          </div>
          <div class="vscode-stats-label">
            {{ statsData().todayStats.label }}
          </div>
        </div>
      </article>
      ...
      <article class="vscode-stats-card vscode-stats-card--messages">
        ...
        <div class="vscode-stats-content">
          <div
            class="vscode-stats-value"
            [attr.aria-label]="
              statsData().weekStats.messages + ' ' + statsData().weekStats.label
            "
          >
            {{ statsData().weekStats.messages }}
          </div>
          <div class="vscode-stats-label">
            {{ statsData().weekStats.label }}
          </div>
        </div>
      </article>
      ...
      <article class="vscode-stats-card vscode-stats-card--tokens">
        ...
        <div class="vscode-stats-content">
          <div
            class="vscode-stats-value"
            [attr.aria-label]="
              statsData().totalStats.tokens + ' ' + statsData().totalStats.label
            "
          >
            {{ statsData().totalStats.tokens | number }}
          </div>
          <div class="vscode-stats-label">
            {{ statsData().totalStats.label }}
          </div>
        </div>
      </article>
    </div>
...
export class AnalyticsStatsGridComponent {
  // ✅ Modern signal-based input (was @Input() decorator)
