...
[`.codex/agents/`](./.codex/agents) (one `.toml` per agent). Codex may invoke
them when their specialization would materially improve the task. Reviewer
agents run in the read-only sandbox.
