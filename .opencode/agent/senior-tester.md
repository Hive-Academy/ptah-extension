...
- Clarification trigger: more than one defensible definition of correct, or the test level (unit, integration, e2e) changes what must be built and the task does not say; stop before test-report.md. Proceed when the task names what to test or acceptance criteria enumerate the cases.
