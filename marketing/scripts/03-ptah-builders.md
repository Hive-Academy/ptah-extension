...
Ptah Builders is a membership built around one course: build a production SaaS end to end, using Ptah, alongside me.

[lower-third: title="Abdallah Khalil", subtitle="Founder, Ptah"]
[keyword: Builders]

What makes it different from a typical course is what you keep afterward. You get the reference codebase we build during the course.

[b-roll: canvas-orchestra — while saying "reference codebase"]

And you get the exact Ptah setup that built it — the agents, the skills, the orchestration workflows, the specs — so you're not starting from a blank workspace, you're starting from a working one.

[b-roll: skills-tour — while saying "the skills"]
[keyword: the exact setup]

On top of the course, there are weekly live sessions where we talk through whatever's actually changing that week — new models, new patterns, things that worked and things that didn't.
...
**Title:** What Ptah Builders actually is
...
**Tags:** ptah builders, saas course, build in public, ai coding orchestra, production saas, founding member
