...
**Global tags (add to every upload):**
`ptah, ai coding assistant, ai agents, autonomous agents, ai coding orchestra, vs code extension, developer tools, ai pair programming, ai for developers, agentic coding`

---

## Playlist order (impact-first — set this as the playlist sequence)
...
**Tags:** parallel ai agents, multi agent, ai orchestra, concurrent agents, ai coding
...
**Tags:** ai code editor, edit code with ai, ai diff, in-editor ai, codebase aware ai
...
**Tags:** multi model, ai ensemble, llm comparison, model debate, ai code review
...
**Tags:** ai from phone, telegram bot, discord bot, slack ai, remote ai agents, mobile devops
...
**Tags:** ai memory, persistent memory, rag, semantic search, long term memory ai
...
**Tags:** self improving ai, skill synthesis, ai learning, reusable workflows, agent skills
...
**Tags:** scheduled ai, cron agents, automated code review, unattended agents, ai automation
...
**Tags:** ai desktop app, electron ai, coding cockpit, local ai, ai workspace
...
**Tags:** mcp, model context protocol, ai plugins, ai marketplace, extend ai, mcp servers
...
**Tags:** bring your own model, local ai, api keys, byok, ai privacy, configurable ai
...
**Tags:** ai cost tracking, token usage, session analytics, ai spend, llm cost
...
**Tags:** monaco editor, built in terminal, code editor, xterm, integrated editor
...
**Tags:** ai onboarding, project scan, codebase aware, setup wizard, custom agents
...
• Persistent memory + hybrid code search — indexes your project before the first message and keeps what it learns long after the last.
• Compounding skills — repeat a workflow and Ptah turns it into a reusable skill, judged and promoted automatically.
• Up to 9 parallel agents — a main agent fans work out to sub-agents, each with its own model and context window.
• Scheduled + mobile — run agents like cron jobs, and trigger/approve work from Telegram, Discord, or Slack, even by voice.
• No lock-in — bring any model and switch providers mid-session without losing context.
...
```
0:00 The problem: AI that forgets
0:22 What Ptah is — remembers, learns, ships
0:56 Pillar 1 — Persistent memory + code search
