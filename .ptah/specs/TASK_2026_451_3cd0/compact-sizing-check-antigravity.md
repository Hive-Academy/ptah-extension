...
Direct evidence from [implementation-plan.md](file:///D:/projects/ptah-extension/.claude-worktrees/task-442-fluid-canvas-spans/.ptah/specs/TASK_2026_442_68ba/implementation-plan.md):
- **Deferred height tiers ([implementation-plan.md:70-74](file:///D:/projects/ptah-extension/.claude-worktrees/task-442-fluid-canvas-spans/.ptah/specs/TASK_2026_442_68ba/implementation-plan.md#L70-L74)):**
...
- **Explicit out-of-scope exclusions ([implementation-plan.md:388-390](file:///D:/projects/ptah-extension/.claude-worktrees/task-442-fluid-canvas-spans/.ptah/specs/TASK_2026_442_68ba/implementation-plan.md#L388-L390)):**
...
- **Originating context notes ([context.md:37-38, 52-55](file:///D:/projects/ptah-extension/.claude-worktrees/task-442-fluid-canvas-spans/.ptah/specs/TASK_2026_442_68ba/context.md#L37-L55)):**
...
The compact mode toggle in [canvas-tile.component.ts](file:///D:/projects/ptah-extension/.claude-worktrees/task-442-fluid-canvas-spans/libs/frontend/canvas/src/lib/canvas-tile.component.ts) updates only the presentation layer inside the chat view. It has no connection to stored canvas intent, `packRows()`, `computeLayout()`, or Gridstack geometry.
...
1. **Gridstack Item Geometry**:
   ...
   In [canvas-layout.service.ts:12-13, 140-150](file:///D:/projects/ptah-extension/.claude-worktrees/task-442-fluid-canvas-spans/libs/frontend/canvas/src/lib/canvas-layout.service.ts#L12-L13), `cellHeightFor()` enforces:
   ```ts
...
2. **Tile Component Shell**:
   In [canvas-tile.component.ts:91](file:///D:/projects/ptah-extension/.claude-worktrees/task-442-fluid-canvas-spans/libs/frontend/canvas/src/lib/canvas-tile.component.ts#L91), the host element root `.canvas-tile` has `class="canvas-tile flex flex-col border rounded-lg h-full overflow-hidden"`.
   In [canvas-tile.component.ts:227](file:///D:/projects/ptah-extension/.claude-worktrees/task-442-fluid-canvas-spans/libs/frontend/canvas/src/lib/canvas-tile.component.ts#L227), the outlet wrapper div has `class="flex-1 min-h-0 overflow-hidden"`.
3. **Chat View Component**:
   In [chat-view.component.html:1, 3, 8, 10](file:///D:/projects/ptah-extension/.claude-worktrees/task-442-fluid-canvas-spans/libs/frontend/chat/src/lib/components/templates/chat-view.component.html#L1-L10):
   ```html
...
4. **Compact Session Card Organism**:
   In [compact-session-card.component.ts:58, 64, 89](file:///D:/projects/ptah-extension/.claude-worktrees/task-442-fluid-canvas-spans/libs/frontend/chat/src/lib/components/molecules/compact-session/compact-session-card.component.ts#L58-L89):
...
5. **Singleton Override**:
   In [canvas-workspace-grid.component.ts:136-141](file:///D:/projects/ptah-extension/.claude-worktrees/task-442-fluid-canvas-spans/libs/frontend/canvas/src/lib/canvas-workspace-grid.component.ts#L136-L141), whenever there is only 1 tile, CSS forces `gridstack.singleton > gridstack-item { width: 100% !important; height: 100% !important; }`.

### 2. Height (`h`) and Width (`w`) Derivation Today

- **Height (`h`)**:
  Derived exclusively in [canvas-layout.service.ts:104-116](file:///D:/projects/ptah-extension/.claude-worktrees/task-442-fluid-canvas-spans/libs/frontend/canvas/src/lib/canvas-layout.service.ts#L104-L116):
  ```ts
...
- **Width (`w`)**:
  Derived solely from `TileIntent.width` via `effectiveUnits(tile.width, capacity)` in [canvas-layout-intent.ts:154-162](file:///D:/projects/ptah-extension/.claude-worktrees/task-442-fluid-canvas-spans/libs/frontend/canvas/src/lib/canvas-layout-intent.ts#L154-L162).
...
1. **Hardcoded Height in Layout Derivation**  
   [canvas-layout.service.ts:5, 110-112](file:///D:/projects/ptah-extension/.claude-worktrees/task-442-fluid-canvas-spans/libs/frontend/canvas/src/lib/canvas-layout.service.ts#L5)  
...
2. **Per-Grid Viewport Height Floor**  
   [canvas-layout.service.ts:12-13, 140-150](file:///D:/projects/ptah-extension/.claude-worktrees/task-442-fluid-canvas-spans/libs/frontend/canvas/src/lib/canvas-layout.service.ts#L12-L13)  
...
3. **`TileIntent` Model Lacks Height / View-Mode Dimension**  
   [canvas-layout-intent.ts:37-42](file:///D:/projects/ptah-extension/.claude-worktrees/task-442-fluid-canvas-spans/libs/frontend/canvas/src/lib/canvas-layout-intent.ts#L37-L42)  
...
4. **Pure 1D Horizontal Row Packing**  
   [canvas-layout-intent.ts:185-219](file:///D:/projects/ptah-extension/.claude-worktrees/task-442-fluid-canvas-spans/libs/frontend/canvas/src/lib/canvas-layout-intent.ts#L185-L219)  
...
5. **Compact View Mode Toggle Disconnected from Canvas State**  
   [canvas-tile.component.ts:198-202, 411-413](file:///D:/projects/ptah-extension/.claude-worktrees/task-442-fluid-canvas-spans/libs/frontend/canvas/src/lib/canvas-tile.component.ts#L198-L202)  
...
6. **TASK_2026_442 Specification Explicitly Deferred Height Tiers**  
   [implementation-plan.md:70-74, 388-390](file:///D:/projects/ptah-extension/.claude-worktrees/task-442-fluid-canvas-spans/.ptah/specs/TASK_2026_442_68ba/implementation-plan.md#L70-L74)  
...
7. **CSS Flexbox and Percentage Rules Force Full Height**  
   - [canvas-tile.component.ts:91, 227](file:///D:/projects/ptah-extension/.claude-worktrees/task-442-fluid-canvas-spans/libs/frontend/canvas/src/lib/canvas-tile.component.ts#L91) (`h-full`, `flex-1 min-h-0`)
   - [chat-view.component.html:1, 3, 8, 10](file:///D:/projects/ptah-extension/.claude-worktrees/task-442-fluid-canvas-spans/libs/frontend/chat/src/lib/components/templates/chat-view.component.html#L1-L10) (`h-full`, `flex-1`, `min-h-0`)
   - [compact-session-card.component.ts:58, 64, 89](file:///D:/projects/ptah-extension/.claude-worktrees/task-442-fluid-canvas-spans/libs/frontend/chat/src/lib/components/molecules/compact-session/compact-session-card.component.ts#L58-L89) (card host and root `h-full`, activity feed `flex-1 min-h-0`)

8. **Gridstack Resizing Configured for Horizontal Only**  
   [canvas-workspace-grid.component.ts:179](file:///D:/projects/ptah-extension/.claude-worktrees/task-442-fluid-canvas-spans/libs/frontend/canvas/src/lib/canvas-workspace-grid.component.ts#L179)  
...
1. **Pass View Mode as a Projection Input**:
   - In [canvas-workspace-grid.component.ts](file:///D:/projects/ptah-extension/.claude-worktrees/task-442-fluid-canvas-spans/libs/frontend/canvas/src/lib/canvas-workspace-grid.component.ts), inject `TabManagerService` (already imported in the canvas library).
...
2. **Define Discrete Height Units**:
   - In [canvas-layout-intent.ts](file:///D:/projects/ptah-extension/.claude-worktrees/task-442-fluid-canvas-spans/libs/frontend/canvas/src/lib/canvas-layout-intent.ts):
...
4. **Adaptive Viewport Scaling**:
   - In [canvas-layout.service.ts:140-150](file:///D:/projects/ptah-extension/.claude-worktrees/task-442-fluid-canvas-spans/libs/frontend/canvas/src/lib/canvas-layout.service.ts#L140-L150), update `cellHeightFor()` to divide available height by the total vertical units `max(y + h)` across all positioned tiles, rather than assuming `rows * 6`. Exclude compact tiles from the `MIN_TILE_VIEWPORT_RATIO = 0.9` floor.
5. **Mode-Aware Singleton Styling**:
   - In [canvas-workspace-grid.component.ts:136-141](file:///D:/projects/ptah-extension/.claude-worktrees/task-442-fluid-canvas-spans/libs/frontend/canvas/src/lib/canvas-workspace-grid.component.ts#L136-L141), disable the `height: 100% !important` override when the singleton tile is compact.
