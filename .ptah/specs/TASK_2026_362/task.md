...
type: FEATURE
title: >-
  Native Ptah agent loop on pi-ai as a second conductor beside the Claude Agent
  SDK
depends_on: []
created: '2026-08-31T12:00:00.000Z'
updated: '2026-09-26T14:40:57.060Z'
description: >-
  ...
  NativeAgentAdapter behind the existing IAgentAdapter port so users can pick it
  or the Claude Agent SDK conductor per session. Ptah MCP tools become
