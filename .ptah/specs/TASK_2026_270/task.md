...
description: >-
  ...
  offers no platform choice, five uncoordinated detectors disagree about what a
  .NET workspace even is, and the tree-sitter layer has no C# grammar so AST and
  symbol-index features are blind to C#. Introduce a declarative StackProfile
  registry binding detection signals, intake vocabulary, toolchain probes,
  scaffold commands and initializer skills per platform; add C# to the AST layer
