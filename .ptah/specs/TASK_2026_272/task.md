...
status: done
type: feature
title: Rework "Send to messaging" into a predictable session hand-off flow
description: >-
  ...
  to a hand-off, show why it is unavailable, filter to running adapters, confirm
  inline, report success and error inline, pin or surface the conversation key,
  and add the spec.
updated: '2026-08-25T21:15:02.207Z'
---
