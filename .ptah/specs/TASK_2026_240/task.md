...
description: >-
  ...
  release" — but it is referenced by no npm script and by none of the 16 workflows
  in .github/workflows, including publish-extension.yml. Nothing enforces it. The
  manifest silently went stale for five days, and because pruneStaleFiles deletes
  any local file the manifest omits, a stale manifest does not merely withhold new
  content — it removes content users already have.
---
