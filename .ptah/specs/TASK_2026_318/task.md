...
description: >-
  ...
  outside `withMcpConfigLock`. It is safe today only by coincidence â€” the two
  ...
  not. Nothing has been observed failing â€” a lost update needs the two to
  interleave mid-write on a key the reconciler would then have to care about â€”
