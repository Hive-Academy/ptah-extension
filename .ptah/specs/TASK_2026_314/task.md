...
description: >-
  ...
  subscribing â€” no warning, no retry, no record. The fix is therefore correct
  ...
  one, silently reverts defect E â€” the index warms on
  ...
  (silence is the whole problem), and ideally make the ordering structural â€” a
