...
Replace the stale Get Started prompt cards with skill-backed content, and let the Tasks board start a task against a chosen specialist role or CLI lane.
