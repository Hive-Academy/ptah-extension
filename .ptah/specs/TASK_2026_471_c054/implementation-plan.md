...
| `Orchestration Skill` | [`.agents/skills/orchestration/SKILL.md:41-73`](../../../.claude/skills/orchestration/SKILL.md#L41-L73) | Defines `/orchestrate TASK_YYYY_NNN` continuation conventions, Gate 0.1 CLI lane discovery, subagent role handoffs, and deliverable verification. |
| `Lane Assignment Spec` | [`.agents/skills/orchestration/references/lane-assignment.md:1-75`](../../../.claude/skills/orchestration/references/lane-assignment.md#L1-L75) | Dictates how roles and phases map to subagents vs CLI lanes (Codex, Claude, Ollama GLM, Copilot). |
