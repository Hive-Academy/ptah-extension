...
Total tasks: 17 | Batches: 4 | Complete: 3/4
...
## Batch 4: The cross-checkout visibility seam — IN_PROGRESS
...
### Task 4.1: `ITaskFolderVisibility` port + token + NoOp — IN_PROGRESS
...
### Task 4.2: `GitTaskFolderVisibility` — the git-backed union reader — IN_PROGRESS
...
### Task 4.3: DI tokens, registration and the public barrel — IN_PROGRESS
...
### Task 4.4: `TaskWriterService.create` — union once, fresh suffix per attempt — IN_PROGRESS
...
### Task 4.5: the 4th-argument fan-out, including the site the plan missed — IN_PROGRESS
...
### Task 4.6: verify the mirrored spawner symbol — IN_PROGRESS
...
### Task 4.7: the two remaining prose payloads in task-specs — IN_PROGRESS
