/**
 * Renders the two generated modules for `vendor-brand-icons.mjs`, as pure
 * string transforms over the vendoring outcomes (prettier formats them after):
 *
 * - the brand table (`brand-marks.generated.ts`): `BRAND_MARKS` and
 *   `MONOGRAM_SLUGS`, read only by lazily loaded code;
 * - the provider subset (`provider-brand-art.generated.ts`): the
 ...
 * specifier of the provider module (`./provider-brand-art.generated`).
 */
