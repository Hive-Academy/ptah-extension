...
export class SessionReplayService {
    ...
    for (const msg of mainMessages) {
      ...
      if (msg.type === 'user' && msg.message?.content) {
        ...
        if (msg.message.usage) {
          ...
          console.log(
            '[SessionReplay] ≡ƒôè Captured usage from assistant message:',
            {
        ...
        if (msg.message.model) {
          ...
          console.log(
            '[SessionReplay] ≡ƒñû Captured model:',
            currentAssistantModel
          );
        }
  ...
  /**
   * Build a map of agentId ΓåÆ agent data from agent sessions.
   ...
   * Returns a map of toolUseId ΓåÆ agentId.
   */
  ...
  private createAssistantMessageFromTree(
    ...
    console.log('[SessionReplay] ≡ƒô¥ Creating assistant message:', {
      messageId,
      hasUsage: !!usage,
      hasTokens: !!tokens,
      tokens: tokens,
