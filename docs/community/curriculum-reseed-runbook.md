...
Sections 2–4 are therefore written as *correct and currently unused*. They are
...
The failure being designed against is *a mis-typed start date silently shifting
ten member-visible dates*. Every plausible mis-typing moves the last date — a
