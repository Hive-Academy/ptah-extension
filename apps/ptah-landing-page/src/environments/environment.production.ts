...
export const environment = {
   ...
   * - Pro: $5/month, $50/year (30-day trial)
   *
  ...
  paddle: {
    ...
    /** Price ID for Pro Monthly ($5/month with 30-day trial) - from Paddle dashboard */
    proPriceIdMonthly: 'pri_01kk26dzbsqrn8qfxbb5a5yhzr',
    /** Price ID for Pro Yearly ($50/year with 30-day trial) - from Paddle dashboard */
