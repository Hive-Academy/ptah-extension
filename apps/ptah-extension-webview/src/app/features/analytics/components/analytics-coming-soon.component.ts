...
/**
 * VS Code Analytics Coming Soon - Pure Presentation Component
 ...
 */
@Component({
  selector: 'vscode-analytics-coming-soon',
  standalone: true,
  imports: [LucideAngularModule],

  template: `
    <section class="vscode-coming-soon" [attr.aria-label]="'Future analytics features'">
...
export class VSCodeAnalyticsComingSoonComponent {
