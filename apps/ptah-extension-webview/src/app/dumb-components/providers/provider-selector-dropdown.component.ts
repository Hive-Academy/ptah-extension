...
import { ProviderInfo } from '../../core/services/provider.service';
...
@Component({
  selector: 'app-provider-selector-dropdown',
  standalone: true,
  ...
  template: `
    <div class="provider-selector-container">
      ...
      <button
        ...
        [attr.aria-label]="'Select AI provider. Current: ' + (currentProvider()?.name || 'None')"
      >
  ...
  styles: [
    `
      ...
      .status-indicator {
        ...
        &.unavailable {
          background: var(--vscode-gitDecoration-ignoredResourceForeground, #9e9e9e);
        }
      }
      ...
      .provider-status {
        ...
        &.initializing {
          ...
          color: var(--vscode-gitDecoration-modifiedResourceForeground, #ffc107);
        }
      }
