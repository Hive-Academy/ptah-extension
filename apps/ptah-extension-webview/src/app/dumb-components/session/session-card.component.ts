...
/**
 * Session Card Component - Dumb Component
 * Individual session display card with actions
 * - Session info with token usage and message count
 * - Quick action buttons (switch, rename, delete)
 * - Visual indicators for current/active session
 * - Responsive card layout with VS Code styling
 */
@Component({
