...
/**
 * Session Selector Component - Dumb Component
 * Displays session selection dropdown with VS Code native styling
 * - Shows current session with token usage
 * - Dropdown list of all available sessions
 * - Quick session creation button
 * - Session management actions
 */
@Component({
  selector: 'vscode-session-selector',
  standalone: true,
