...
/**
 * VS Code Command Bottom Sheet - Pure Presentation Component
 * - Simple bottom sheet overlay with quick commands
 * - No business logic or state management
 * - Pure VS Code styling with smooth animations
 * - Accessible with proper keyboard navigation
 */
@Component({
  selector: 'vscode-command-bottom-sheet',
  standalone: true,
  ...
  template: `
    @if (isOpen) {
      <!-- Backdrop -->
      <div class="vscode-backdrop" (click)="close.emit()" [attr.aria-hidden]="true"></div>
...
export class VSCodeCommandBottomSheetComponent {
  @Input() isOpen: boolean = false;
  @Output() commandSelected = new EventEmitter<QuickCommand>();
  @Output() close = new EventEmitter<void>();

  readonly X = X;

  // Predefined quick commands
  readonly quickCommands: QuickCommand[] = [
    {
      id: 'code-review',
      label: 'Code Review',
