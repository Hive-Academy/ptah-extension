...
/**
 * VS Code Status Bar Component - Pure Presentation
 * - No business logic or state management
 * - Pure VS Code styling with no custom variables
 * - Accessible with proper ARIA labels
 * - Responsive design for mobile webviews
 */
@Component({
  selector: 'vscode-status-bar',
  standalone: true,
...
export class VSCodeStatusBarComponent {
  @Input() statusMessage: string = 'Ready';
  @Input() isConnected: boolean = false;
  @Input() workspaceInfo: WorkspaceInfo | null = null;
