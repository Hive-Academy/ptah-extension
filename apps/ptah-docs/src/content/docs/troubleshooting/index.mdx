...
<Aside type="tip">
If none of the pages here match your issue, open an issue on [GitHub](https://github.com/Hive-Academy/ptah-extension/issues) with your diagnostics block attached.
</Aside>
