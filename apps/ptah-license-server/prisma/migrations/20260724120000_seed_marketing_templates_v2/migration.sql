...
VALUES (
  ...
  '<div style="max-width:600px;margin:0 auto;font-family:Arial,sans-serif;color:#111827;line-height:1.6;"><h1 style="font-size:24px;color:#111827;">You''re invited to become a founding Builder</h1><p>Hi {{firstName}}, you joined the Ptah Builders waitlist — and your invite is ready.</p><p>As a <strong>founding Builder</strong> you get:</p><ul><li>Early access to the full Ptah orchestra before general availability.</li><li>A founding-member price locked in for as long as you stay.</li><li>A direct line to Abdallah and the team to shape what we build next.</li></ul><p style="text-align:center;margin:32px 0;"><a href="https://ptah.live/pricing" style="background-color:#b8860b;color:#ffffff;padding:12px 28px;text-decoration:none;border:1px solid #b8860b;">Claim your founding invite</a></p><p>Spots are limited — this invite is yours to claim while they last.</p><p>— Abdallah, creator of Ptah</p></div>',
  ARRAY['firstName']::TEXT[],
  'seed',
  CURRENT_TIMESTAMP,
  CURRENT_TIMESTAMP
